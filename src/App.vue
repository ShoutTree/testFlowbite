<template>
  <div :class="{ dark: isDark }">
    <div class="min-h-screen text-black dark:text-white transition-colors">
      <!-- 1. 固定 SettingsPanel 到左侧，永不移动 -->
      <div class="fixed left-0 top-0 bottom-0 w-64 border-r border-gray-300 dark:border-gray-700 z-10 bg-gray-200 dark:bg-gray-800">
